...
public class AuthenticationService implements AuthenticationUseCase {
	...
	@Autowired
	AuthenticationService(AuthenticationManager authManager, TokenService tokenService, TokenBlacklist tokenBlacklist,
			LoginAttemptTracker loginAttemptTracker, Clock clock, ApplicationEventPublisher eventPublisher) {
	...
	private String formatLockoutMessage(Duration remaining) {
		...
		return String.format("Account temporarily locked due to multiple failed login attempts. "
