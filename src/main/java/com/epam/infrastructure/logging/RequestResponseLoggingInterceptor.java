...
public class RequestResponseLoggingInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
		...
		log.info("=== Incoming Request === TransactionId: {} | Method: {} | URI: {} | Query: {} | RemoteAddr: {}",
				...
				request.getQueryString() != null ? request.getQueryString() : "N/A", request.getRemoteAddr());
	...
	public void afterCompletion(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
		...
		if (ex != null) {
			log.error("=== Request Failed === TransactionId: {} | Method: {} | URI: {} | Status: {} | Exception: {}",
			...
			if ("ERROR".equals(logLevel)) {
				log.error("=== Request Completed with Error === TransactionId: {} | Method: {} | URI: {} | Status: {}",
						transactionId, request.getMethod(), request.getRequestURI(), response.getStatus());
			}
			else {
				log.info("=== Request Completed === TransactionId: {} | Method: {} | URI: {} | Status: {}",
						transactionId, request.getMethod(), request.getRequestURI(), response.getStatus());
			}
		}
	}
