...
// // Given
// ChangeLoginRequest request = new ChangeLoginRequest("john.doe", "oldPassword123",
// "newPassword456");
//
// when(authService.authenticate(any(Credentials.class))).thenReturn(testTrainee);
...
// verify(gymFacade).updateTraineePassword(any(String.class), eq("newPassword456"));
...
// // Given
// ChangeLoginRequest request = new ChangeLoginRequest("jane.smith", "oldPassword123",
// "newPassword456");
//
...
// verify(gymFacade).updateTrainerPassword(any(String.class), eq("newPassword456"));
...
// // Given
// ChangeLoginRequest request = new ChangeLoginRequest("john.doe", "wrongOldPassword",
// "newPassword456");
//
// when(authService.authenticate(any(Credentials.class)))
// .thenThrow(new AuthenticationException("Invalid credentials"));
