...
class UsernameFinderTest {
	...
	void findLatestUsername_shouldReturnUsernameWithHighestSerialNumber() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("John.Doe1"),
				new TestUserDAO("John.Doe5"), new TestUserDAO("John.Doe3"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldHandleLargeSerialNumbers() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("John.Doe999"),
				new TestUserDAO("John.Doe1000"), new TestUserDAO("John.Doe500"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldIgnoreNonMatchingPrefixes() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("Jane.Smith1"),
				new TestUserDAO("Jane.Smith5"), new TestUserDAO("John.Doe2"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldReturnEmptyWhenNoPrefixMatch() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("Jane.Smith"), new TestUserDAO("Jane.Smith1"),
				new TestUserDAO("Bob.Jones"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldHandleNullUsernames() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO(null),
	...
	void findLatestUsername_shouldTreatInvalidSerialAsZero() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("John.DoeABC"), // Invalid
				// serial
				new TestUserDAO("John.Doe1"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldTreatBaseUsernameAsSerialZero() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), // Serial 0
	...
	void findLatestUsername_shouldHandleMixedValidAndInvalidSerials() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("John.Doe2"),
				new TestUserDAO("John.DoeABC"), new TestUserDAO("John.Doe10"), new TestUserDAO("John.Doe!@#"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldHandleVeryLargeSerialNumbers() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("John.Doe999999999"),
	...
	void findLatestUsername_shouldBeCaseSensitive() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("john.doe"), new TestUserDAO("John.Doe"),
				new TestUserDAO("John.Doe1"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldWorkWithDifferentExtractors() {
		...
		Collection<CustomDAO> daos = List.of(new CustomDAO("John.Doe"), new CustomDAO("John.Doe3"),
				new CustomDAO("John.Doe1"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldHandleLeadingZerosInSerial() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("John.Doe01"), // Leading
				// zero
	...
	void findLatestUsername_shouldHandleSpecialCharactersInPrefix() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.O'Brien"), new TestUserDAO("John.O'Brien1"),
	...
	void findLatestUsername_shouldWorkWithUnsortedCollection() {
		...
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe7"), new TestUserDAO("John.Doe2"),
				new TestUserDAO("John.Doe100"), new TestUserDAO("John.Doe1"), new TestUserDAO("John.Doe50"));
		String prefix = "John.Doe";
	...
	void findLatestUsername_shouldHandleZeroSerial() {
		// Given
		Collection<TestUserDAO> daos = List.of(new TestUserDAO("John.Doe"), new TestUserDAO("John.Doe0"),
				new TestUserDAO("John.Doe1"));
		String prefix = "John.Doe";
