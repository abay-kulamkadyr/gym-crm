...
class TrainingSessionIntegrationTest extends GymIntegrationTestBase {
    ...
    void deleteTrainee_removesAllAssociatedTrainingSessions() {
        TrainingType cardio = requireTrainingType(TrainingTypeEnum.CARDIO);
        Trainer trainer = gymFacade.createTrainerProfile(
        ...
        gymFacade.createTraining(new CreateTrainingRequest(
                ...
                LocalDateTime.now(),
                60,
                Optional.of(cardio.getTrainingTypeName()),
                trainee.getUsername(),
                trainer.getUsername()));
        gymFacade.createTraining(new CreateTrainingRequest(
                "Training 2",
